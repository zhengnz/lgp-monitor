...
(function() {
  var Promise, Server, _, child_process, events, exec, fs, hprose, os, pm2, shell;
  ...
  Server = (function() {
    ...
    Server.prototype.get_project_env = function(name) {
      return this.true_app_list().then(function(apps) {
        var obj;
        obj = _.find(apps, function(app) {
          return app.name === name;
        });
        return Promise.resolve(obj.pm2_env.env);
      });
    };

    Server.prototype.js_compile = function(name) {
      return Promise.all([this.get_project_env(name), this.get_project_path(name)]).spread((function(_this) {
        return function(env, p) {
          ...
          n.on('message', function(m) {
            return _this.console(m.msg);
          });
          return n.on('exit', function() {
            return _this.console('Compile Complete');
          });
        };
      })(this));
    };
